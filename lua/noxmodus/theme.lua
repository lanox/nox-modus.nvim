...
theme.set_highlights = function()
  ...
  hl(0, "DiffText", { fg = c.gray08, bg = c.DiffText })
  hl(0, "DiffAdd", { fg = c.gray08, bg = c.DiffAdd })
  hl(0, "DiffChange", { fg = c.gray08, bg = c.DiffChange })
  hl(0, "DiffDelete", { fg = c.gray08, bg = c.DiffDelete })
