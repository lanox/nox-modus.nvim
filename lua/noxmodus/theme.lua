...
theme.set_highlights = function()
  ...
  hl(0, "ErrorMsg", { fg = c.light_red, bg = c.bg, bold=true, })
  ...
  hl(0, "Search", { fg = c.bg, bg = c.gray08 })
  hl(0, "IncSearch", { fg = c.bg, bg = c.gray08 })
  hl(0, "Pmenu", { fg = c.fg, bg = c.gray01 })
  hl(0, "PmenuSel", { fg = c.bg, bg = c.gray03 })
  hl(0, "PmenuSbar", { fg = c.fg, bg = c.gray01 })
  hl(0, "PmenuThumb", { fg = c.fg, bg = c.gray03 })
  hl(0, "DiffText", { fg = c.gray08, bg = c.red })
  hl(0, "DiffAdd", { fg = c.gray08, bg = c.greenhl })
  hl(0, "DiffChange", { fg = c.gray08, bg = c.orange })
  hl(0, "DiffDelete", { fg = c.gray08, bg = c.red })
  ...
  hl(0, "String", { fg = c.gray03, bg = 'NONE' })
  ...
  hl(0, "Constant", { fg = c.gray03, bg = 'NONE' })
  hl(0, "Type", { fg = c.gray03, bg = 'NONE' })
  hl(0, "StorageClass", { fg = c.gray03, bg = 'NONE' })
  hl(0, "Structure", { fg = c.gray03, bg = 'NONE' })
  hl(0, "Typedef", { fg = c.gray03, bg = 'NONE' })
  hl(0, "PreProc", { fg = c.sage_green, bg = 'NONE' })
  hl(0, "Include", { fg = c.gray05, bg = 'NONE' })
  hl(0, "Define", { fg = c.gray05, bg = 'NONE' })
  hl(0, "Macro", { fg = c.gray05, bg = 'NONE' })
  hl(0, "PreCondit", { fg = c.gray05, bg = 'NONE' })
  hl(0, "Statement", { fg = c.gray03, bg = 'NONE' })
  hl(0, "Conditional", { fg = c.gray03, bg = 'NONE' })
  hl(0, "Repeat", { fg = c.gray03, bg = 'NONE' })
  hl(0, "Label", { fg = c.gray03, bg = 'NONE' })
  hl(0, "Operator", { fg = c.gray03, bg = 'NONE' })
  hl(0, "Keyword", { fg = c.gray03, bg = 'NONE' })
  hl(0, "Exception", { fg = c.gray03, bg = 'NONE' })
  hl(0, "Identifier", { fg = c.sage_green, bg = 'NONE' })
  hl(0, "Function", { fg = 'NONE', bg = 'NONE' })
  hl(0, "Special", { fg = c.gray03, bg = 'NONE' })
  hl(0, "SpecialChar", { fg = c.gray03, bg = 'NONE' })
  hl(0, "Tag", { fg = c.gray03, bg = 'NONE' })
  hl(0, "Delimiter", { fg = c.gray03, bg = 'NONE' })
  hl(0, "Debug", { fg = c.gray03, bg = 'NONE' })
  ...
  hl(0, "CmpItemAbbrMatch", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemAbbrMatchFuzzy", { fg = c.gray03, bg = 'NONE' })
  hl(0, "CmpItemKindFunction", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindMethod", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindConstructor", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindClass", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindEnum", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindEvent", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindInterface", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindStruct", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindVariable", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindField", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindProperty", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindEnumMember", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindConstant", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindKeyword", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindModule", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindValue", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindUnit", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindText", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindSnippet", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindFile", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindFolder", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindColor", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindReference", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindOperator", { fg = c.gray08, bg = 'NONE' })
  hl(0, "CmpItemKindTypeParameter", { fg = c.gray08, bg = 'NONE' })
  ...
  -- Navic
  hl(0, "NavicIconsFile", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsModule", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsNamespace", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsPackage", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsClass", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsMethod", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsProperty", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsField", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsConstructor", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsEnum", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsInterface", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsFunction", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsVariable", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsConstant", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsString", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsNumber", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsBoolean", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsArray", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsObject", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsKey", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsKeyword", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsNull", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsEnumMember", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsStruct", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsEvent", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsOperator", { fg = c.gray08, bg = 'NONE' })
  hl(0, "NavicIconsTypeParameter", { fg = c.gray08, bg = 'NONE' })
